...
public class SearchForProductJPanel extends javax.swing.JPanel {
   ...
   Supplier supplier;
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
       ...
       int findID = Integer.parseInt(idField.getText());
       Product foundProduct = supplier.getProductCatalog().searchProduct(findID);
       if(foundProduct == null){
           JOptionPane.showMessageDialog(null, "Product doesnt exist", "Information", JOptionPane.INFORMATION_MESSAGE);
       }else
       {
           ViewProductDetailJPanel viewProductPanel = new ViewProductDetailJPanel(workArea,foundProduct);
           workArea.add("ViewProductDeatilJPanel",viewProductPanel);
