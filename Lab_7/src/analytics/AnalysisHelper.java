...
//    public void getMaxLikeCommontPost() {
...
//    }
    public void getMaxLikeCommontPost() {
        ...
        if (commentWithMaxLikes != null) {
            int postId = commentWithMaxLikes.getPostId();
            int maxLikes = commentWithMaxLikes.getLikes();
            System.out.println("Q2 - post with most likes per comment: " + postId + " : " + maxLikes);
        } else {
            System.out.println("No comments found in the data store.");
        }
    }
    ...
    public void getPassiveCommentUsers() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            Integer commentCount = commentNumbers.getOrDefault(user.getId(), 0);
